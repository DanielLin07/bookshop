...
import com.daniellin07.bookshop.entity.Book;
...
import com.daniellin07.bookshop.service.BookService;
import com.daniellin07.bookshop.service.CategoryService;
...
public class BookController {
     ...
     * 根据ID获取书的Category
     *
     * @param book 应该使用GET的，但是会产生不合法URI异常，待解决
     */
     ...
     * @param file    图片
     * @return 应该使用PUT，可是需要上传图片，表单提交无法用PUT，待解决
     */
